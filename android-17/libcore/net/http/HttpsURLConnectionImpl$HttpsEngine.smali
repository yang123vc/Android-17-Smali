...
.method private constructor <init>(Llibcore/net/http/HttpURLConnectionImpl;Ljava/lang/String;Llibcore/net/http/RawHeaders;Llibcore/net/http/HttpConnection;Llibcore/net/http/RetryableOutputStream;Llibcore/net/http/HttpsURLConnectionImpl;)V
    .registers 8
    .param p1, "policy"    # Llibcore/net/http/HttpURLConnectionImpl;
    .param p2, "method"    # Ljava/lang/String;
    .param p3, "requestHeaders"    # Llibcore/net/http/RawHeaders;
    .param p4, "connection"    # Llibcore/net/http/HttpConnection;
    .param p5, "requestBody"    # Llibcore/net/http/RetryableOutputStream;
    .param p6, "enclosing"    # Llibcore/net/http/HttpsURLConnectionImpl;
...
.method synthetic constructor <init>(Llibcore/net/http/HttpURLConnectionImpl;Ljava/lang/String;Llibcore/net/http/RawHeaders;Llibcore/net/http/HttpConnection;Llibcore/net/http/RetryableOutputStream;Llibcore/net/http/HttpsURLConnectionImpl;Llibcore/net/http/HttpsURLConnectionImpl$1;)V
    .registers 8
    .param p1, "x0"    # Llibcore/net/http/HttpURLConnectionImpl;
    .param p2, "x1"    # Ljava/lang/String;
    .param p3, "x2"    # Llibcore/net/http/RawHeaders;
    .param p4, "x3"    # Llibcore/net/http/HttpConnection;
    .param p5, "x4"    # Llibcore/net/http/RetryableOutputStream;
    .param p6, "x5"    # Llibcore/net/http/HttpsURLConnectionImpl;
    .param p7, "x6"    # Llibcore/net/http/HttpsURLConnectionImpl$1;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method static synthetic access$300(Llibcore/net/http/HttpsURLConnectionImpl$HttpsEngine;)Ljavax/net/ssl/SSLSocket;
    .registers 2
    .param p0, "x0"    # Llibcore/net/http/HttpsURLConnectionImpl$HttpsEngine;
...
.method private makeSslConnection(Z)Z
    ...
    .prologue
    .line 459
    iget-object v0, p0, Llibcore/net/http/HttpsURLConnectionImpl$HttpsEngine;->connection:Llibcore/net/http/HttpConnection;
    ...
    iput-object v0, p0, Llibcore/net/http/HttpsURLConnectionImpl$HttpsEngine;->connection:Llibcore/net/http/HttpConnection;
    ...
    .line 462
    iget-object v0, p0, Llibcore/net/http/HttpsURLConnectionImpl$HttpsEngine;->policy:Llibcore/net/http/HttpURLConnectionImpl;

    iget-object v1, p0, Llibcore/net/http/HttpsURLConnectionImpl$HttpsEngine;->connection:Llibcore/net/http/HttpConnection;
...
.method private makeTunnel(Llibcore/net/http/HttpURLConnectionImpl;Llibcore/net/http/HttpConnection;Llibcore/net/http/RequestHeaders;)V
    .registers 12
    .param p1, "policy"    # Llibcore/net/http/HttpURLConnectionImpl;
    .param p2, "connection"    # Llibcore/net/http/HttpConnection;
    .param p3, "requestHeaders"    # Llibcore/net/http/RequestHeaders;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method protected connect()V
    ...
    .line 445
    iget-object v2, p0, Llibcore/net/http/HttpsURLConnectionImpl$HttpsEngine;->connection:Llibcore/net/http/HttpConnection;
