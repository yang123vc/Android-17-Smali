...
.method private getAuthorizationCredentials(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v12, p0, Llibcore/net/http/HttpURLConnectionImpl;->url:Ljava/net/URL;
...
.method private getResponse()Llibcore/net/http/HttpEngine;
    ...
    .line 285
    :cond_47
    iget-object v4, p0, Llibcore/net/http/HttpURLConnectionImpl;->method:Ljava/lang/String;
...
.method private initHttpEngine()V
    ...
    iput-boolean v1, p0, Llibcore/net/http/HttpURLConnectionImpl;->connected:Z

    .line 234
    :try_start_f
    iget-boolean v1, p0, Llibcore/net/http/HttpURLConnectionImpl;->doOutput:Z

    if-eqz v1, :cond_1d

    .line 235
    iget-object v1, p0, Llibcore/net/http/HttpURLConnectionImpl;->method:Ljava/lang/String;
    ...
    iput-object v1, p0, Llibcore/net/http/HttpURLConnectionImpl;->method:Ljava/lang/String;
    ...
    iget-object v3, p0, Llibcore/net/http/HttpURLConnectionImpl;->method:Ljava/lang/String;
...
.method private processResponseHeaders()Llibcore/net/http/HttpURLConnectionImpl$Retry;
    ...
    .line 363
    :cond_55
    iget-object v2, p0, Llibcore/net/http/HttpURLConnectionImpl;->url:Ljava/net/URL;
    ...
    iput-object v3, p0, Llibcore/net/http/HttpURLConnectionImpl;->url:Ljava/net/URL;
    ...
    iget-object v4, p0, Llibcore/net/http/HttpURLConnectionImpl;->url:Ljava/net/URL;
...
.method public final addRequestProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 493
    iget-boolean v0, p0, Llibcore/net/http/HttpURLConnectionImpl;->connected:Z
...
.method final getChunkLength()I
    ...
    .prologue
    .line 459
    iget v0, p0, Llibcore/net/http/HttpURLConnectionImpl;->chunkLength:I
...
.method final getFixedContentLength()I
    ...
    .prologue
    .line 454
    iget v0, p0, Llibcore/net/http/HttpURLConnectionImpl;->fixedContentLength:I
...
.method public final getInputStream()Ljava/io/InputStream;
    ...
    .prologue
    .line 164
    iget-boolean v2, p0, Llibcore/net/http/HttpURLConnectionImpl;->doInput:Z
    ...
    iget-object v3, p0, Llibcore/net/http/HttpURLConnectionImpl;->url:Ljava/net/URL;
...
.method final processAuthHeader(ILlibcore/net/http/ResponseHeaders;Llibcore/net/http/RawHeaders;)Z
    ...
    .param p2, "response"    # Llibcore/net/http/ResponseHeaders;
    .param p3, "successorRequestHeaders"    # Llibcore/net/http/RawHeaders;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
