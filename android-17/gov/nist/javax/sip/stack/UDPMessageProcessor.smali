...
.method public run()V
    ...
    invoke-interface {v9, v10}, Lgov/nist/core/StackLogger;->logDebug(Ljava/lang/String;)V
    :try_end_c6
    .catch Ljava/net/SocketTimeoutException; {:try_start_32 .. :try_end_c6} :catch_6b
    .catch Ljava/net/SocketException; {:try_start_32 .. :try_end_c6} :catch_c8
    .catch Ljava/io/IOException; {:try_start_32 .. :try_end_c6} :catch_10b
    .catch Ljava/lang/Exception; {:try_start_32 .. :try_end_c6} :catch_132
    ...
    monitor-enter v10
    :try_end_fb
    .catch Ljava/net/SocketTimeoutException; {:try_start_f1 .. :try_end_fb} :catch_6b
    .catch Ljava/net/SocketException; {:try_start_f1 .. :try_end_fb} :catch_c8
    .catch Ljava/io/IOException; {:try_start_f1 .. :try_end_fb} :catch_10b
    .catch Ljava/lang/Exception; {:try_start_f1 .. :try_end_fb} :catch_132
    ...
    throw v9
    :try_end_10b
    .catch Ljava/net/SocketTimeoutException; {:try_start_10a .. :try_end_10b} :catch_6b
    .catch Ljava/net/SocketException; {:try_start_10a .. :try_end_10b} :catch_c8
    .catch Ljava/io/IOException; {:try_start_10a .. :try_end_10b} :catch_10b
    .catch Ljava/lang/Exception; {:try_start_10a .. :try_end_10b} :catch_132
    ...
    :try_end_130
    .catch Ljava/net/SocketTimeoutException; {:try_start_129 .. :try_end_130} :catch_6b
    .catch Ljava/net/SocketException; {:try_start_129 .. :try_end_130} :catch_c8
    .catch Ljava/io/IOException; {:try_start_129 .. :try_end_130} :catch_10b
    .catch Ljava/lang/Exception; {:try_start_129 .. :try_end_130} :catch_132
