...
.method static synthetic access$000(Ljava/util/concurrent/DelayQueue;)Ljava/util/concurrent/locks/ReentrantLock;
    .registers 2
    .param p0, "x0"    # Ljava/util/concurrent/DelayQueue;
...
.method public drainTo(Ljava/util/Collection;I)I
    ...
    invoke-interface {v0, v3}, Ljava/util/concurrent/Delayed;->getDelay(Ljava/util/concurrent/TimeUnit;)J
    :try_end_2b
    .catchall {:try_start_1c .. :try_end_2b} :catchall_42
...
.method public poll(JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/Delayed;
    ...
    check-cast v2, Ljava/util/concurrent/Delayed;
    :try_end_11
    .catchall {:try_start_9 .. :try_end_11} :catchall_a2
    ...
    :try_end_4a
    .catchall {:try_start_2f .. :try_end_4a} :catchall_a2
    ...
    :try_end_90
    .catchall {:try_start_7f .. :try_end_90} :catchall_a2
    ...
    :try_end_95
    .catchall {:try_start_90 .. :try_end_95} :catchall_b8
    ...
    throw v9
    :try_end_c1
    .catchall {:try_start_b9 .. :try_end_c1} :catchall_a2
.end method
