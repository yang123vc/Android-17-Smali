...
.method static synthetic access$1000(Landroid/content/SyncManager$SyncHandler;Landroid/accounts/Account;Ljava/lang/String;)Landroid/os/PowerManager$WakeLock;
    .registers 4
    .param p0, "x0"    # Landroid/content/SyncManager$SyncHandler;
...
.method private dispatchSyncOperation(Landroid/content/SyncOperation;)Z
    .registers 14
    .param p1, "op"    # Landroid/content/SyncOperation;
...
.method private manageSyncAlarmLocked(JJ)V
    ...
    # getter for: Landroid/content/SyncManager;->SYNC_NOTIFICATION_DELAY:J
    ...
    # getter for: Landroid/content/SyncManager;->MAX_TIME_PER_SYNC:J
    ...
    # invokes: Landroid/content/SyncManager;->ensureAlarmService()V
...
.method private maybeStartNextSyncLocked()J
    ...
    # getter for: Landroid/content/SyncManager;->INITIAL_ACCOUNTS_ARRAY:[Landroid/accounts/Account;
    ...
    # invokes: Landroid/content/SyncManager;->getConnectivityManager()Landroid/net/ConnectivityManager;
    ...
    # getter for: Landroid/content/SyncManager;->MAX_SIMULTANEOUS_INITIALIZATION_SYNCS:I
    ...
    :cond_4bc
    # getter for: Landroid/content/SyncManager;->MAX_SIMULTANEOUS_REGULAR_SYNCS:I
...
.method private runBoundToSyncAdapter(Landroid/content/SyncManager$ActiveSyncContext;Landroid/content/ISyncAdapter;)V
    ...
    # invokes: Landroid/content/SyncManager;->increaseBackoffSetting(Landroid/content/SyncOperation;)V
...
.method private runSyncFinishedOrCanceledLocked(Landroid/content/SyncResult;Landroid/content/SyncManager$ActiveSyncContext;)V
    ...
    # invokes: Landroid/content/SyncManager;->clearBackoffSetting(Landroid/content/SyncOperation;)V
    ...
    # invokes: Landroid/content/SyncManager;->setDelayUntilTime(Landroid/content/SyncOperation;J)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    # invokes: Landroid/content/SyncManager;->isSyncStillActive(Landroid/content/SyncManager$ActiveSyncContext;)Z
...
.method public insertStartSyncEvent(Landroid/content/SyncOperation;)J
    .registers 9
    .param p1, "syncOperation"    # Landroid/content/SyncOperation;
...
.method public stopSyncEvent(JLandroid/content/SyncOperation;Ljava/lang/String;IIJ)V
    .registers 20
    .param p1, "rowId"    # J
    .param p3, "syncOperation"    # Landroid/content/SyncOperation;
