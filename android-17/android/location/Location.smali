...
.method private static computeDistanceAndBearing(DDDD[F)V
    ...
    .line 291
    .local v4, "A":D
    const-wide/high16 v75, 0x3ff0000000000000L
    ...
    const-wide/high16 v77, 0x40d0000000000000L

    div-double v77, v73, v77

    const-wide/high16 v79, 0x40b0000000000000L

    const-wide/high16 v81, -0x3f78000000000000L

    const-wide/high16 v83, 0x4074000000000000L
    ...
    .line 331
    const-wide/high16 v75, 0x4090000000000000L

    div-double v75, v73, v75

    const-wide/high16 v77, 0x4070000000000000L

    const-wide/high16 v79, -0x3fa0000000000000L
    ...
    .line 334
    .local v6, "B":D
    const-wide/high16 v75, 0x4030000000000000L

    div-double v75, v44, v75

    mul-double v75, v75, v31

    const-wide/high16 v77, 0x4010000000000000L

    const-wide/high16 v79, 0x4010000000000000L

    const-wide/high16 v81, 0x4008000000000000L
    ...
    const-wide/high16 v81, 0x4000000000000000L
    ...
    const-wide/high16 v81, 0x4018000000000000L

    div-double v81, v6, v81

    mul-double v81, v81, v23

    const-wide/high16 v83, -0x3ff8000000000000L

    const-wide/high16 v85, 0x4010000000000000L
    ...
    const-wide/high16 v81, -0x4010000000000000L

    const-wide/high16 v83, 0x4000000000000000L
    ...
    :cond_209
    const-wide/high16 v75, 0x4000000000000000L
...
.method public static convert(Ljava/lang/String;)D
    ...
    const-wide/high16 v19, 0x404e000000000000L
