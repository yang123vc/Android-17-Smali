...
.method public handleMessage(Landroid/os/Message;)V
    ...
    # invokes: Landroid/webkit/WebView;->cancelWebCoreTouchEvent(IIZ)V
    ...
    # invokes: Landroid/webkit/WebView;->pinScrollBy(IIZI)Z
    ...
    # invokes: Landroid/webkit/WebView;->scrollLayerTo(II)V
    ...
    # invokes: Landroid/webkit/WebView;->updateSelection()V
    ...
    # invokes: Landroid/webkit/WebView;->removeTouchHighlight()V
    ...
    # invokes: Landroid/webkit/WebView;->inFullScreenMode()Z
    ...
    # invokes: Landroid/webkit/WebView;->nativeScrollableLayer(IILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    # invokes: Landroid/webkit/WebView;->doShortPress()V
    ...
    # invokes: Landroid/webkit/WebView;->inEditingMode()Z
    ...
    # invokes: Landroid/webkit/WebView;->spawnContentScrollTo(II)V
    ...
    # invokes: Landroid/webkit/WebView;->setContentScrollTo(II)Z
    ...
    # invokes: Landroid/webkit/WebView;->nativeReplaceBaseContent(I)V
    ...
    # invokes: Landroid/webkit/WebView;->nativeCreate(ILjava/lang/String;Z)V
    ...
    # invokes: Landroid/webkit/WebView;->nativeSetPauseDrawing(IZ)V
    ...
    # invokes: Landroid/webkit/WebView;->displaySoftKeyboard(Z)V
    ...
    # invokes: Landroid/webkit/WebView;->updateTextSelectionFromMessage(IILandroid/webkit/WebViewCore$TextSelectionData;)V
    ...
    # invokes: Landroid/webkit/WebView;->hideSoftKeyboard()V
    ...
    # invokes: Landroid/webkit/WebView;->navHandledKey(IIZJ)Z
    ...
    # invokes: Landroid/webkit/WebView;->nativeCursorIsTextInput()Z
    ...
    # invokes: Landroid/webkit/WebView;->updateWebTextViewPosition()V
    ...
    # invokes: Landroid/webkit/WebView;->clearTextEntry()V
    ...
    # invokes: Landroid/webkit/WebView;->viewInvalidate(IIII)V
    ...
    # invokes: Landroid/webkit/WebView;->doMotionUp(II)V
    ...
    # invokes: Landroid/webkit/WebView;->dismissFullScreenMode()V
    ...
    # invokes: Landroid/webkit/WebView;->getVisibleTitleHeightImpl()I
    ...
    # invokes: Landroid/webkit/WebView;->setTouchHighlightRects(Ljava/util/ArrayList;)V
    ...
    # invokes: Landroid/webkit/WebView;->nativeSelectAt(II)V
