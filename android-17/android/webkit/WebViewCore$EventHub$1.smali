...
.method public handleMessage(Landroid/os/Message;)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeRevealSelection()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->webkitDrawLayers()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeRequestLabel(II)Ljava/lang/String;
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeUpdateFrameCacheIfLoading()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeScrollFocusedTextInput(FI)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeRegisterURLSchemeAsLocal(Ljava/lang/String;)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeContentInvalidateAll()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->key(Landroid/view/KeyEvent;Z)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeClick(IIZ)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->viewSizeChanged(Landroid/webkit/WebView$ViewSizeData;)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeSetGlobalBounds(IIII)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeCloseIdleConnections()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativePause()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeResume()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeFreeMemory()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeReplaceTextfieldText(IILjava/lang/String;III)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->passToJs(ILjava/lang/String;IIZZZZ)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeScrollLayer(ILandroid/graphics/Rect;)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeTouchUp(IIIII)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeHandleTouchEvent(I[I[I[IIII)Z
    ...
    :goto_5c6
    # invokes: Landroid/webkit/WebViewCore;->nativeSetFocusControllerActive(Z)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeMoveFocus(II)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeMoveMouseIfLatest(IIII)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeStopPaintingCaret()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeRetrieveHref(II)Ljava/lang/String;
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeRetrieveAnchorText(II)Ljava/lang/String;
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeRetrieveImageSource(II)Ljava/lang/String;
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeUpdateFrameCache()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->sendUpdateTextEntry()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeDeleteSelection(III)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeSetSelection(II)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeModifySelection(II)Ljava/lang/String;
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeSendListBoxChoices([ZI)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeSendListBoxChoice(I)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeSetBackgroundColor(I)V
    ...
    :goto_811
    # invokes: Landroid/webkit/WebViewCore;->nativeDumpDomTree(Z)V
    ...
    :goto_826
    # invokes: Landroid/webkit/WebViewCore;->nativeDumpRenderTree(Z)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeDumpNavTree()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeDumpV8Counters()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeSetJsFlags(Ljava/lang/String;)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeGeolocationPermissionsProvide(Ljava/lang/String;ZZ)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeSplitContent(I)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeClearContent()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeProvideVisitedHistory([Ljava/lang/String;)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeValidNodeAndBounds(IILandroid/graphics/Rect;)Z
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeFullScreenPluginHidden(I)V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativePluginSurfaceReady()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeGetTouchHighlightRects(III)Ljava/util/ArrayList;
    ...
    # invokes: Landroid/webkit/WebViewCore;->useMockDeviceOrientation()V
    ...
    # invokes: Landroid/webkit/WebViewCore;->nativeAutoFillForm(I)V
